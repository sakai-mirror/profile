...
public class SakaiPersonManagerImpl extends HibernateDaoSupport implements SakaiPersonManager
{
	...
	public SakaiPerson create(String agentUuid, String uid, Type recordType)
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("create(String " + agentUuid + ", String " + uid + ", Type " + recordType + ")");
		}
		if (agentUuid == null || agentUuid.length() < 1) throw new IllegalArgumentException("Illegal agentUuid argument passed!");; // a null uid is valid
